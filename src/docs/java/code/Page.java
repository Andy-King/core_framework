...
import org.jee.framework.core.utils.WebUtils;
...
public class Page implements Serializable {
	...
	public Page(HttpServletRequest request, int pageSize, String url){
		...
		//this.totalCount = this.pageSize * pageCount;
		//this.url = url;
		final int pageNo = Integer.parseInt(WebUtils.getParameter(request, PAGE_NUMBER_PARAMETER_NAME, "1"));
		final int totalPages = Integer.parseInt(WebUtils.getParameter(request, PAGE_TOTAL_PARAMETER_NAME, "0"));
		this(pageNo, pageSize,	totalPages,	url);
	}
