...
public abstract class BeanValidatorUtils {
	...
	public static List<String> extractMessage(ConstraintViolationException e) {
		return extractMessage((Set<ConstraintViolation<?>> )e.getConstraintViolations());
	}
	...
	public static Map<String, String> extractPropertyAndMessage(ConstraintViolationException e) {
		return extractPropertyAndMessage((Set<ConstraintViolation<?>> )e.getConstraintViolations());
	}
	...
	public static Map<String, String> extractPropertyAndMessage(Set<? extends ConstraintViolation<?>> constraintViolations) {
		final Map<String, String> errorMessages = Maps.newHashMap();
		for (ConstraintViolation<?> violation : constraintViolations) {
	...
	public static List<String> extractPropertyAndMessageAsList(ConstraintViolationException e) {
		return extractPropertyAndMessageAsList((Set<ConstraintViolation<?>> )e.getConstraintViolations(), " ");
	}
	...
	public static List<String> extractPropertyAndMessageAsList(ConstraintViolationException e, String separator) {
		return extractPropertyAndMessageAsList((Set<ConstraintViolation<?>> )e.getConstraintViolations(), separator);
	}
