...
public abstract class ObjectUtils {
    ...
    private ObjectUtils() {
        throw new AssertionError("No org.jee.framework.core.utils.ObjectUtils instances for you!");
    }
    ...
    */
	...
	/**
	 * 判断是否空字符串
	 * 注: obj == null || "".equals(obj) || "   ".equals(obj)
	 * 上面三种情况都为true
	 * @param obj
	 * @return
	 */
	public static boolean isEmpty(Object obj) {
		return ( isNull(obj) || "".equals(obj) || obj.toString().trim().length() == 0 );
	}
